...
const Home = () => {  
  ...
  return (
    <>
      ...
      <section className="min-h-screen w-full flex flex-col md:justify-end xl:flex-row xl:items-end py-32 xl:py-0 xl:justify-between gap-10 lg:gap-20 px-8 xl:px-20 bg-bg-50">
